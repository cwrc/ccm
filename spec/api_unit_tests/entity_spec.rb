...
describe "entity" do
  ...
  it "creates one organization entity" do
    t = CcmApiTest.new
    ...
    raise "Namespace of PID of person should be \"org_name\". Current PID #{pid}" unless pid.start_with?("organization:");
    
    #Retrieving the newly created entity and making sure that it has the first and last names
    t.get("entity/#{pid}")
    t.text_body_include?("<namePart>#{org_name}</namePart>")
  end
